...
<b class="text-light"> RESTO </b>
  ...
  <ul class="navbar-nav">
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" id="me">Member</a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="/qr">Login</a>
