        ...
        <div class="col-md-12">
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <!-------------------------------------------------------- HR --------------------------------------------------------> <hr>
                        <ul class="nav nav-tabs mb-3 col-md-9">
                            <li class="nav-item">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="card mb-6 shadow-sm">
                                    <div class="row no-gutters">
                                        <img src="{{asset('assets/masakans/'.$row->file_gambar_masakan)}}" class="card-img-top mt-3" alt="...">
                                        <div class="card-body">
                                            <p class="card-title text-center"><b>{{$row->nama_masakan}}</b></p>
                                            @if($row->diskon > 0)
                                                <div class="text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <button class="btn btn-danger btn-block col-lg-12 mt-2 mr-1 text-center" data-toggle="modal" data-target="#orderMasakan-{{ $row->id_masakan }}">Order</button>
                                                    </div>
                                                    @else
                                                    <div class="d-flex justify-content-center">
                        ...
                        <!-- END-ITEM -->
                            @push('modal')
                            <div class="modal fade" id="orderMasakan-{{ $row->id_masakan }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">{{$row->nama_masakan}}</h5>
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <!-- @if($row->diskon > 0)
                                                                <div class="text-center">
                                                                    ...
                                                                    <input type="hidden" id="id_masakan" hidden name="id_masakan" value="{{$row->id_masakan}}">
                                                                </div>
                                                            @else
                                                                <div class="text-center mt-4">
...
<script>
    $(function(){
        $('.tombol-hapus').click(function(){
            ...
            $("#orderMasakan-{{ $row->id_masakan }} form").attr('action',url);
            $('#orderMasakan-{{ $row->id_masakan }}').modal('show');
        });
    });
