        ...
        <label>Masukan Foto Karyawan</label>
          <div class="form-group">
            <div class="custom-file">
              <input name="file_foto_waiter" type="file" accept="image/x-png,image/gif,image/jpeg" class="form-control" id="inputGambar_masakan" placeholder=" masukan file gambar buku" name="gambar">
